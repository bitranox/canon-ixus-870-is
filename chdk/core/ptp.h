...
enum ptp_chdk_command {
  ...
  PTP_CHDK_GetMJPEGFrame,       // Get MJPEG webcam frame
                                 // param2 is JPEG quality (1-100), 0 = use current
                                 // param3 is flags: bit 0 = start streaming, bit 1 = stop streaming
                                 // return param1 is frame data size (0 if no frame)
                                 // return param2 is frame width
                                 // return param3 is frame height
                                 // return param4 is frame number
                                 // return data is JPEG frame
};
